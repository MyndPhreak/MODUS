  ...
  <div class="p-6 lg:p-8 space-y-6">
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex items-center gap-3">
        <div
          class="w-9 h-9 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center shrink-0"
        >
      ...
      >
        ...
        <div class="relative space-y-5">
          ...
          <UFormField
            ...
            hint="Where public milestone announcements are posted. Leave empty to post in the same channel the user typed in."
          >
            <USelectMenu
          ...
          <UFormField
            ...
            hint="Messages shorter than this character count won't count toward milestones. Default: 5."
          >
            <UInput
