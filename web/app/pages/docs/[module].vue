<template>
  <NuxtLayout name="landing">
    <div class="landing-container pt-32 pb-20 max-w-3xl">
      <NuxtLink
        to="/docs"
      ...
      >
        Docs are temporarily unavailable. The bot may be offline — try again
        shortly.
      </div>
      ...
      <template v-else>
        <h1 class="text-3xl font-black text-white tracking-tight mb-2 capitalize">
          {{ currentModule.name }}
        </h1>
        ...
        <div class="space-y-8">
          ...
          >
            <div class="flex items-baseline gap-2 mb-2">
              <code class="text-sm font-bold text-purple-300">/{{ cmd.name }}</code>
            </div>
